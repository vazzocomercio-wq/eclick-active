...
import { Megaphone, Sparkles, Plus, Calendar, Image as ImageIcon, ChevronRight, BarChart3, GitCompareArrows, Rocket, SlidersHorizontal, Radio, Palette, Brain, Radar, LayoutGrid, Scissors } from 'lucide-react';
    ...
    <div className="flex flex-1 flex-col overflow-hidden">
      <header className="flex flex-wrap items-center justify-between gap-2 border-b border-border bg-background px-4 py-3 md:px-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Button variant="outline" size="sm" asChild>
            <Link href="/social/cortes">
              <Scissors className="h-3.5 w-3.5" />
              <span className="hidden md:inline ml-1">Cortes</span>
            </Link>
          </Button>
          <Button variant="outline" size="sm" asChild>
          ...
          <Button variant="outline" size="sm" asChild>
            <Link href="/social/estilos">
              <Palette className="h-3.5 w-3.5" />
              <span className="hidden md:inline ml-1">Estilos</span>
            </Link>
          </Button>
          {brands.length > 1 && (
            <Button variant="outline" size="sm" asChild>
          ...
          <Button variant="outline" size="sm" asChild>
            <Link href="/social/tendencias">
              <Radar className="h-3.5 w-3.5" />
              <span className="hidden md:inline ml-1">Tendências</span>
            </Link>
          </Button>
          <Button variant="outline" size="sm" asChild>
