  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-4 px-8 py-16 text-center">
        ...
        <p className="text-lg font-medium text-foreground">Em desenvolvimento</p>
        <p className="max-w-md text-sm text-muted-foreground">
          Esta seção ainda está sendo construída. Em breve você poderá usar todas as
          funcionalidades de <span className="font-medium text-foreground">{title}</span>{' '}
          aqui.
        </p>
      </div>
    </div>
